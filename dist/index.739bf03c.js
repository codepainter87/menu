...
// TODO NOT IN USE 
_utils.preloadImages('.tiles__line-img').then(()=>document.body.classList.remove('loading')
);
// frame element
...
const toggleMenu = ()=>{
    if (event.currentTarget.classList.contains('is-active')) closeMenu();
    else openMenu();
};
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l4AUa","ebWYT"], "ebWYT", "parcelRequiredf5e")
