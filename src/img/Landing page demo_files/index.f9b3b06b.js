...
const openModal = ()=>{
    ...
    isAnimating = true;
    const profile1 = event.srcElement.parentElement.parentElement;
    const profileImage = profile1.querySelector('.profile__image img');
    const profileName = profile1.querySelector('.profile__name') ? profile1.querySelector('.profile__name').innerText : "";
    const profileTitle = profile1.querySelector('.profile__title') ? profile1.querySelector('.profile__title').innerText : "";
    const profileBio = profile1.querySelector('.profile__bio') ? profile1.querySelector('.profile__bio').innerHTML : "";
...
//     }
// };
for (const profile of profiles)profile.addEventListener('click', openModal);
modalCloser.addEventListener('click', closeModal);

},{"gsap":"fPSuC"}]},["aEP6z","aHHgN"], "aHHgN", "parcelRequiredf5e")
