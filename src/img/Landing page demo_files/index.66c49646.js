...
// TODO NOT IN USE 
_utils.preloadImages('.hero').then(()=>document.body.classList.remove('loading')
);
// frame element
...
const toggleMenu = ()=>{
    if (window.document.body.classList.contains('menu-open')) closeMenu();
    else openMenu();
};
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fDuhn","dTgwB"], "dTgwB", "parcelRequiredf5e")
